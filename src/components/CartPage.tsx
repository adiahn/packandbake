        ...
        <div className="lg:col-span-8">
          <div className="bg-white rounded-xl shadow-soft overflow-hidden mb-8 lg:mb-0">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center border border-gray-200 rounded-lg overflow-hidden">
                          <button
                            ...
                            className="p-2 text-gray-500 hover:text-amber-600 hover:bg-gray-50"
            ...
            <div className="bg-gray-50 p-6 flex items-center justify-between">
              <Link to="/tools" className="text-gray-600 hover:text-amber-600 flex items-center">
                <ArrowLeft className="w-4 h-4 mr-2" />
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="border-t border-gray-200 pt-4 mt-4">
                <div className="flex justify-between font-medium">
                  ...
                  <span className="text-lg text-amber-600">{formatPrice(subtotal)}</span>
                </div>
              </div>
            </div>
